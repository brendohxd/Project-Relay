...
> Generated from [project/status.json](project/status.json) on 2026-08-04. Do not edit this file directly.

**Stage:** pre-alpha<br>
**Current milestone:** M2 — GitHub collaboration adapter<br>
**Roadmap:** 18/28 actionable items complete; 0 blocked; 3 deferred.

| Milestone | Status | Complete | Blocked | Deferred |
|---|---:|---:|---:|---:|
| M0 — Protocol kernel | complete | 3/3 | 0 | 0 |
| M1 — Local vertical slice | complete | 6/6 | 0 | 0 |
| M2 — GitHub collaboration adapter | planned | 4/6 | 0 | 0 |
...
- [x] **M2-CONTRACT: Fake-GitHub contract, conflict, retry, and idempotency tests** — done
  - Evidence: [Network-free fake GitHub adapter](packages/github-adapter/src/fake-github-adapter.js), [Adversarial fake-adapter contract tests](test/m2-fake-github-adapter.test.js), [External adversarial input audit](docs/reviews/M2_ADVERSARIAL_INPUT_AUDIT.md)
...
## Remote MCP interoperability prototype

**Visibility:** operational-summary-only<br>
**Boundary:** Only synthetic and public-safe Relay records may enter the Cloudflare D1 prototype. Credentials, confidential development context, ITSM equations, datasets, results, manuscripts, and scientific decisions remain prohibited. Human decision writes are disabled.

- [x] **Authenticated Cloudflare Worker and D1 prototype** — done
  - Evidence: [Authenticated Worker health endpoint](https://project-relay-prototype.brendohxd.workers.dev/health), [Remote MCP implementation PR](https://github.com/brendohxd/Project-Relay/pull/6)
- [x] **Three-client identity, conflict, hash-chain, and read smoke test** — done
  - Evidence: [Remote MCP implementation PR](https://github.com/brendohxd/Project-Relay/pull/6)
- [ ] **Attach the reviewed custom MCP domain** — blocked
  - Blocker (external): The registrar must complete nameserver delegation before Cloudflare can activate relay.itsm-cosmology.com.
  - Next: Continue using the authenticated workers.dev endpoint until delegation is confirmed.
- [ ] **Production authentication and confidential workloads** — deferred
